  ...
  public seedDefaults() {
    ...
    this.widgets = [
      ...
      },
      {
        ...
        org_id: orgId,
        dataset_id: 'f0000000-0000-0000-0000-000000000002',
        title: 'D3.js Regional Sales Treemap Breakdown',
        type: 'treemap',
        grid_layout: { x: 6, y: 4, w: 6, h: 4, minW: 4, minH: 3 },
        query_config: { metrics: ['sales'], dimensions: ['category', 'region'], groupBy: ['category', 'region'], limit: 20 },
        visual_config: { colors: ['#3B82F6', '#10B981', '#F59E0B'], showLegend: true, numberFormat: 'currency' },
        refresh_interval_seconds: 0,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
      },
